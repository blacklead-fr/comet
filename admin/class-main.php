...
class main extends Comet_Interface {
    ...
    protected function content(){
        ...
        echo '<div class="comet-column col0">';
        echo $this->welcome();
        echo '</div>';
    ...
    private function welcome(){
        ...
        $o .= '<p>';
        $o .= __( 'My name is Nicolas, I\'m the creator of Comet and I wanted to write some lines. I recently rewrited Comet to make it works without dependencies to prevent errors and reduce updates. I\'m grateful to have had the chance to make Comet, I\'ve learned so much and it works well but I can\'t compete with teams and being as reponsive. I always thought Comet could be running as a company but I\'m not able to do this alone and it\'s so much work in addition to build Comet. So I\'m forced to make it a side project even if it\'s not the end. I truly appreciate the time you took to read about Comet.', 'comet' );
        $o .= '<br><br>';
        $o .= sprintf( __( 'Warmly, %s.' ), 'Nicolas' );
        $o .= '</p>';
        $o .= '</div>';
