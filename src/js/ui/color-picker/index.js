import { isString, isNumber, isNode, isArray, isDefined, isFunction, isObject } from '../../utils/is.js';
import __range from '../range/index.js';
    ...
    const __color = {
        ...
        hsb: {
            ...
            toColor: function(){
                ...
                if( !isArray( hsb ) || hsb.length < 3 ){
                    return '';

                }
                alpha = isDefined( hsb[3] ) ? __core.parse.value( hsb[3], 0, 1, 1, true ) : 1;
    ...
    const __core = {
        ...
        parse: {
            ...
            color: function( x ){
                ...
                return ( isString( x ) && ( __core.parse.rgb( x ) || __core.parse.hex( x ) ) );
