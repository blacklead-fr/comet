...
The visual page builder that's light, fast, and free. Bring your ideas to life fast, Comet is the only plugin you need to design without writing code.
...
1. Smart layout tool. Drag & Drop to add a new column, row or section with a single tool.
2. Drag & Drop page elements. Insert page elements anywhere on your design.
3. Advanced gradients. Apply custom gradients to columns, rows, sections and some page elements.
